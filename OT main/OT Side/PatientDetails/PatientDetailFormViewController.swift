...
class PatientDetailFormViewController: UIViewController, PHPickerViewControllerDelegate {
    ...
    // --- Form Fields ---
    lazy var firstNameField = PatientDetailFormViewController.createFormField(placeholder: "First Name")
    lazy var lastNameField = PatientDetailFormViewController.createFormField(placeholder: "Last Name")
    
    lazy var genderField = PatientDetailFormViewController.createFormField(placeholder: "Gender")
    lazy var bloodGroupField = PatientDetailFormViewController.createFormField(placeholder: "Blood Group")
    lazy var addressField = PatientDetailFormViewController.createFormField(placeholder: "Address")
    lazy var parentNameField = PatientDetailFormViewController.createFormField(placeholder: "Parent's Name")
    
    // This field will remain read-only
    lazy var parentContactField = PatientDetailFormViewController.createFormField(placeholder: "Parent Contact")
    
    lazy var referredByField = PatientDetailFormViewController.createFormField(placeholder: "Referred By")
    lazy var existingDiagnosisField = PatientDetailFormViewController.createFormField(placeholder: "Existing Diagnosis")
    lazy var existingMedicationField = PatientDetailFormViewController.createFormField(placeholder: "Existing Medication")
    ...
    func setupNavigationBarMenu() {
        ...
        // Combine into Menu
        let mainMenu = UIMenu(title: "", children: [editAction, resetLinkAction, deleteAction])
...
extension PatientDetailFormViewController: UITextFieldDelegate {
